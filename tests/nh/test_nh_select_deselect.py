...
# def test_neighborhood_numeric_get_item_correct_inputs(ds_neighborhoods):
#     ds_neighborhoods_numeric = ds_neighborhoods.nh.set_neighborhood_name(
#         [f"Neighborhood {x+1}" for x in range(5)], [str(x) for x in range(5)]
#     )
...
# def test_neighborhood_numeric_get_item_wrong_inputs(ds_neighborhoods):
#     ds_neighborhoods_numeric = ds_neighborhoods.nh.set_neighborhood_name(
#         [f"Neighborhood {x+1}" for x in range(5)], [str(x) for x in range(5)]
#     )
...
# def test_neighborhood_numeric_deselect(ds_neighborhoods):
#     ds_neighborhoods_numeric = ds_neighborhoods.nh.set_neighborhood_name(
#         [f"Neighborhood {x+1}" for x in range(5)], [str(x) for x in range(5)]
#     )
...
# def test_neighborhood_deselect_numeric_wrong_input(ds_neighborhoods):
#     ds_neighborhoods_numeric = ds_neighborhoods.nh.set_neighborhood_name(
#         [f"Neighborhood {x+1}" for x in range(5)], [str(x) for x in range(5)]
#     )
